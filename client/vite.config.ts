...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Attendance — Midnight Aurora',
        short_name: 'Attendance',
        description: 'Personal Academic Attendance Assistant',
        theme_color: '#080c16',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /\/api\/attendance\/dashboard/i,
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-ui': ['lucide-react', 'canvas-confetti', 'date-fns', 'clsx', 'tailwind-merge'],
        },
      },
    },
